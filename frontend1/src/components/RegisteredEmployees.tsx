    ...
    return (
        <>
            ...
            <div className="bg-slate-100 p-4 md:p-6 rounded-xl shadow-lg max-w-full md:max-w-[700px] mx-auto">
                <div className="grid grid-cols-3 font-bold border-b-2 pb-2 mb-4 text-sm md:text-base">
                    <div>Name</div>
                    <div>ID</div>
                    <div>Password</div>
                </div>
                ...
                <ul className="overflow-auto max-h-[350px]">
                    {registeredEmployees.map((employee) => (
                        <li className="grid grid-cols-3 gap-4 p-2 border-b text-sm md:text-base cursor-pointer hover:bg-gray-200"
