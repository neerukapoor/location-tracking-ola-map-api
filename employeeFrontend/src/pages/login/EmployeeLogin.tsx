...
const Login = () => {
    const {loading, login} = useEmployeeLogin();
            ...
            <div className="bg-slate-100 p-6 rounded-xl shadow-lg max-w-md w-full">
                <form onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-[1rem]">
                        <h1 className="text-center text-3xl font-semibold text-blue-400">Employee Portal for Geo Location</h1>
                        <label className="input input-bordered flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" /></svg>
                        <input type="text" className="grow" placeholder="Username" value={inputs.uniqueId}
